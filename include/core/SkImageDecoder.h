...
public:
    ...
    void setDisablePreMultiplyAlpha(bool bDisable) { bDisablePreMultiplyAlpha = bDisable;}
    bool getDisablePreMultiplyAlpha() {return bDisablePreMultiplyAlpha;}

    /** Let bEnable be true if the we try to use hardward decoder to decode image.
        The default setting is false.
    */
    void setEnableHwDecode(bool bEnable) { bEnableHwDecode = bEnable; }

    /** Returns true if we are trying to use hardward decoder to decode image.
        The default setting is false.
    */
    bool getEnableHwDecode() { return bEnableHwDecode; }
...
// MStar Android Patch Begin
protected:
    bool                    bDisablePreMultiplyAlpha;
    bool                    bEnableHwDecode;
// MStar Android Patch End
};
