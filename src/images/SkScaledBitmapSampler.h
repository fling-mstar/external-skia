...
public:
    ...
    // MStar Android Patch Begin
    bool beginWithoutPremultiplyAlpha(SkBitmap* dst, SrcConfig sc, bool doDither,
               const SkPMColor* ctable);
    bool next_saveto_ypos(const uint8_t* SK_RESTRICT src, int s32ToYPos);
    bool next_without_step(const uint8_t* SK_RESTRICT src);
